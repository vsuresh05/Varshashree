//Write a C programming to create an extended ASCII table. Print the ASCII values 32 through 255 
//https://www.w3resource.com/c-programming-exercises/basic-declarations-and-expressions/c-programming-basic-exercises-88.php
